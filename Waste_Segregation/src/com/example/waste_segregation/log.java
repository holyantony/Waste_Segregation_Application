 ...
 */
public class log extends Activity implements ConnectionCallbacks,
...
//                OutputStream outputStream = result.getDriveContents().getOutputStream();
                ...
                MetadataChangeSet metadataChangeSet = new MetadataChangeSet.Builder()
                        .setMimeType("appliaction/xls").setTitle("log"+today.monthDay + "_"+ (today.month+1)+"_"+today.year+ ".xls").build();
